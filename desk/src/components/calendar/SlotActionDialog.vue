      ...
      <div class="fixed inset-0 flex items-center justify-center p-4">
        ...
        >
          <DialogPanel class="w-full max-w-sm rounded-lg bg-white p-6 shadow-xl dark:bg-gray-900">
            ...
            <!-- Slot info card -->
            <div class="mt-4 rounded-md bg-gray-50 p-3 dark:bg-gray-700/50 dark:ring-1 dark:ring-gray-600">
            ...
            <div class="mt-5 space-y-3">
              <button
                class="flex w-full items-center gap-3 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-left transition hover:bg-blue-100 dark:border-blue-500 dark:bg-blue-600 dark:hover:bg-blue-700"
                @click="$emit('create-booking', slotInfo)"
              >
                <svg class="h-5 w-5 text-blue-600 dark:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                  <span class="text-sm font-semibold text-blue-700 dark:text-white">Create Booking</span>
                  <p class="text-xs text-blue-600/70 dark:text-blue-100/80">Schedule a customer meeting</p>
                </div>
              </button>

              <button
                v-if="canBlockSlots"
                class="flex w-full items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-left transition hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700/50 dark:hover:bg-gray-700"
