    ...
    <div v-if="currentStep === 2" class="space-y-4">
      <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div v-if="form.scheduled_date">
          ...
          <div v-if="availableSlots.loading" class="flex justify-center py-4">
            <LoadingSpinner size="sm" />
          </div>
          <div v-else-if="availableSlots.data?.available_slots?.length" class="grid grid-cols-3 sm:grid-cols-4 gap-2">
            <button
              v-for="slot in availableSlots.data.available_slots"
              :key="slot.start_time"
