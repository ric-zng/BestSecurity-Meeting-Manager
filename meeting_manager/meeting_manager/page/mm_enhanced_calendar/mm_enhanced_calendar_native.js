...
class EnhancedCalendarController {
    ...
    addStyles() {
        ...
        style.textContent = `
            ...
            /* Blocked Slot Styling - BLACK */
            .fc-timeline-event.ec-blocked-slot {
            ...
            .fc-timeline-event.ec-blocked-slot .fc-event-main {
                color: #ffffff !important;
                font-weight: 500;
            }

            .fc-timeline-event.ec-blocked-slot:hover {
                opacity: 1 !important;
            ...
            [data-theme="dark"] .fc-timeline-event.ec-blocked-slot {
